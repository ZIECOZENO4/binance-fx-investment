        ...
        <div>
            <div className="w-full h-screen flex flex-col md:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8  2xl:space-x-0">
                <div className="w-full md:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                    ...
                    <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12 sm:mx-2">Sorry,Binance FX couldn&apos;t find or load the page you are expecting, kindly contact us if it persists.</p>
                    <Link href="/dashboard" className="flex items-center space-x-2 mb-2 md:mb-4  bg-green-600 hover:bg-green-700 text-gray-100 px-4 py-2 rounded transition duration-150" title="Return Home">
