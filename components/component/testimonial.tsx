    ...
    <div className="w-full py-12 lg:py-24 bg-black text-white">
      <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
        <div className="space-y-3">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-sky-600">Testimonials</h1>
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-gray-300 dark:text-gray-400">Germany</p>
                    </div>
                  </div>
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-gray-300 dark:text-gray-400">United States</p>
                    </div>
                  </div>
                  <div className="space-y-2 text-sm">
                    <p>
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-gray-300 dark:text-gray-400">Canada</p>
                    </div>
                  </div>
                  <div className="space-y-2 text-sm">
                    <p>
