 ...
 * @see https://v0.dev/t/W5JFDBMvWep
 */
      ...
      <div className="space-y-4 p-4">
        ...
        <div className="flex items-center justify-between bg-[#1f1f1f] p-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-white">Campaign</p>
              <p className="text-xs text-gray-400">Binance Halving Horizons 2024</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between bg-[#1f1f1f] p-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-white">System Messages</p>
