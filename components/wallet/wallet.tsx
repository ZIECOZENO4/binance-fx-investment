...
<span className="text-blue-600 text-xl uppercase flex">
  ...
  >
    ...
    <line x1="16" y1="2" x2="16" y2="22"></line>
            ...
            <Link href="/user-profile" className="mt-2 sm:mt-0 mr-2">
