  ...
  return (
    <div className=" bg-[#FFD700] rounded-2xl flex flex-col justify-start align-middle items-start gap-5 p-4 md:px-3 px-20">
      ...
      <div className=" flex flex-row justify-between gap-5 md:gap-10">
        <p className=" font-bold md:text-2xl text-xl font-sono gap-3">ACCOUNT BALANCE</p>
       ...
       <div className="div">
        ...
        <p className=" font-bold md:text-2xl text-xl font-sono gap-3">INVESTMENT BALANCE</p>
