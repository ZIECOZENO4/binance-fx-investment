        ...
        <div className='flex items-center justify-between gap-3 xs:gap-3'>
          {
            bottomLinks.map((link) => {
              ...
              return (
                <Link href={link.route} key={link.label} className={`relative flex flex-col items-center rounded-lg ${isActive ? 'bg-blue-700 text-white border-spacing-[2px]' : 'text-blue-600'} text-xs`}>
