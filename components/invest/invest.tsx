...
<p className=' text-2xl font-bold font-sans gap-3 text-white'> CALCULATE</p>
</div>
      </div>
    <div className='flex flex-row px-2 md:px-[20vw] justify-between pt-8 w-[100vw] bg-slate-700 mt-10 md:mt-20'>
      <motion.header
